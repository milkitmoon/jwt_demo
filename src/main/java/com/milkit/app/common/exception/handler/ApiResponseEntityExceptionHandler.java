...
public class ApiResponseEntityExceptionHandler extends ResponseEntityExceptionHandler {
	...
	protected ResponseEntity<Object> handleRuntimeException(RuntimeException ex, WebRequest request) {
		...
		return handleExceptionInternal(ex, new GenericResponse(ErrorCode.SystemError, ex.getMessage()), new HttpHeaders(), HttpStatus.INTERNAL_SERVER_ERROR, request);
	}
	...
	protected ResponseEntity<Object> handleServiceException(ServiceException ex, WebRequest request) {
		...
		return handleExceptionInternal(ex, new GenericResponse(ex.getCode(), ex.getMessage()), new HttpHeaders(), HttpStatus.INTERNAL_SERVER_ERROR, request);
	}
